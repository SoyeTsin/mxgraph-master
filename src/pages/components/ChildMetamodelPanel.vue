        ...
        <el-tab-pane label="信息" name="first">
            <el-form ref="form" :model="form" label-width="70px">
              ...
              <el-form-item label="标识">
                <el-input
                  v-model="selectData.id_adm_ci_type_attr"
                  class="edge-width"
                  type="text"
                  @input=""/>
              </el-form-item>
              ...
              <el-form-item label="类型">
                <el-input
                  v-model="selectData.column_type"
                  class="edge-width"
                  type="text"
                  @input=""/>
              </el-form-item>
              <el-form-item label="显示类型">
                <el-input
                  v-model="selectData.display_type"
                  class="edge-width"
                  type="text"
                  @input=""/>
              </el-form-item>
              ...
              <el-form-item label="枚举值">
                <el-input
                  v-model="selectData.reference_id"
                  class="edge-width"
                  type="text"
                  @input=""/>
              </el-form-item>
